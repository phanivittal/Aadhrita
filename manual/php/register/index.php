        ...
        <div class="wrapper wrapper--w680">
            <div class="card card-4">
                <div class="card-body">
                    ...
                    <form name="myform" method="POST" action="../insertions/" onsubmit="return validate()" autocomplete="yes">
                        ...
                        if ($_SESSION['rtype']=='MVGR') {
                            echo '
                                <label class="label" hidden="yes">College name :</label>
                                <input class="input--style-4" type="text" name="collegeName" value ="MVGR" hidden="yes">
                            ';
                        }
                        else{
                            echo '
                        ...
                        <div class="row row-space">
                            <div class="col-2">
                                <div class="input-group">
                                    <label class="label">Enter Token Number :</label>
                                    <input class="input--style-4" type="text" name="token" required>
                                </div>
                            </div>
                        </div>
                            <div class="p-t-15">
