        ...
        if($row['etype'] == "CULTURAL" && $_POST["STATUS"] == "TXN_SUCCESS" ) {
            ...
            if ($params[2]=='Txn Success') { 
                ...
                if(!mysqli_query($conn,$sql)){
                    ...
                    <tr>
                        <td colspan = "2">
                            <center><b>Transaction DATA is NOT inserted</b><br/></center>
                        </td>
                    </tr>
                    ';
                }
                    ...
                    for( $j = 0 ; $j < $tsize ; $j++ ){
                        if ($j==0) {
                            $sql2="insert into culturalregistrations values('$teamToken','$eventId','$aad3id[$j]','$uname[$j]','$emails[$j]','lead','$tsize')";
                        }
                        else{
                            $sql2="insert into culturalregistrations values('$teamToken','$eventId','$aad3id[$j]','$uname[$j]','$emails[$j]','member','$tsize')";
                        }
                ...
                if(!mysqli_query($conn,$sql)){
                    ...
                    <tr>
                        <td colspan = "2">
                            <center><b>Transaction2 DATA is NOT inserted</b><br/></center>
                        </td>
                    </tr>
                    ';
                }
