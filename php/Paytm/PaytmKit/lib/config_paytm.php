...
*/
	...
	// define('PAYTM_ENVIRONMENT', 'PROD'); // PROD,TEST saikiran
	// define('PAYTM_MERCHANT_KEY', 'Hb@fXyJ18rGEp94k'); // Hb@fXyJ18rGEp94k, @HknLNWz7YFCySH!
	// define('PAYTM_MERCHANT_MID', 'EzfMKn40833132020367'); // EzfMKn40833132020367, ayDSCT05418194706769
