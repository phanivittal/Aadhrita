...
<head>
  ...
  <title>Aadhrita | Sports Team REgistrations</title>
  ...
  <ul class="nav-links">
	...
	<div class="container jumbotron" >
		...
		<form method="POST" enctype="multipart/form-data" action="./validateShresta_Groupregistrations.php">
		...
		function populate() {
	        ...
	        if (<?php
				...
				for (i=1;i<tsize;i++) {
					...
					var text2 = document.createTextNode("Enter your name"+i);
	        		...
	        		var text2 = document.createTextNode("Enter Mobile no of member "+i);
	         		var div2 = document.createElement("div");
	        		var input2 = document.createElement("input");
	        		div2.className = "form-group";
	           		input2.type = "text";
